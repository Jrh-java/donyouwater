  ...
  <div class="rainfall-chart-container">
    ...
    <div class="chart-header">
      <span style="margin-left:auto;display:flex;align-items:center;">
        ...
        <el-select v-model="selectedRainTime"   class="chart-select" :teleported="false" @change="onRainTimeChange">
...
//     console.log(`RainfallChart: Detected damId change to ${newDamId}. Reloading chart data.`);
//     // 在这里根据 newDamId 重新获取或更新图表数据
//     // 例如: fetchRainfallData(newDamId).then(data => { /* update chart */ });
//     // 为了演示，这里只是简单地重新setOption，您需要替换为实际的数据逻辑
//     if (myChart) {
//       // 假设 rainfallOption.value 依赖于所选大坝的数据，或者您有一个方法来更新它
//       // rainfallOption.value.series[0].data = getNewDataForDam(newDamId); 
//           myChart.setOption(rainfallOption.value, true);
//       console.log('RainfallChart: Chart would be updated here.');
//     }
//   }
// });
...
.chart {
  ...
  height: 280px; /* Explicit height for the chart itself */
}
